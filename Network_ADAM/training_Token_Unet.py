from Network_ADAM.models.Token_Unet import Token_UNet
...
def Token_Unet_train(name, idx):

    full_name = f"ADAM_{name}_{idx}_Token_Unet"
    ...
    network = Token_UNet(prepadding=2, feature_base=16, patch_size=patch_size, img_size=input_resolution)
