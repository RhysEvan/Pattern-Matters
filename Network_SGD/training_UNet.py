...
def unet_train(name, idx):
    ...
    labels_file = f"data/{labels_name}_labels_{idx}.pth"
    ...
    perf_file = f"output/perf/{'_'.join(full_name.split('_')[:-1])}_3x3_kernel.txt"
    ...
    network = UNet(prepadding=2, feature_base=16, expansive_path=False, scale_factor=2)
